...
using Web.RabbitMq.Client.Senders;
using WebApplicationRabbitMqSignalR.Helpers;
using WebApplicationRabbitMqSignalR.Repositories.Interfaces;
using WebApplicationRabbitMqSignalR.Services.Interface;

namespace WebApplicationRabbitMqSignalR.Services;
...
public class WeatherForecastService : IWeatherForecastService
{
    ...
    public async Task<IEnumerable<WeatherForecast>> Get(string city, DateTime period)
    {
        ...
        IEnumerable<WeatherForecast> cityWeatherForecasts = await _weatherForecastRepository.Get(city, period);
